...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desenvolvido por Washington Luis ©2023");
		...
		lblLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagens/login.png")));
