...
public class Login extends JFrame {
	...
	private static final long serialVersionUID = 2166640821006984528L;
	...
	public Login() {
		...
		txtUsuario.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				 if (txtUsuario.getText().equals("Informe o Nome de Usuário.")) {
					 txtUsuario.setText("");
		...
		txtUsuario.setText("Informe o Nome de Usuário.");
		...
		JLabel labelTitulo = new JLabel("INICIAR SESSÂO");
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/imagens/lOGO-50PX.png")));
	...
	private void Login() {
	     ...
	     String Senha="alura";
	        ...
	        if(txtUsuario.getText().equals(Usuario) && contrase.equals(Senha)){
